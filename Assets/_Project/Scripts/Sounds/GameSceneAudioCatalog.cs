...
namespace _Project.Scripts.Sounds
{
    public class GameSceneAudioCatalog : IAudioCatalog
    {
        ...
        {
            _audioCatalog = await _assetLoader.LoadAssetByID<AudioCatalogSO>(AssetsIDs.AUDIO_CATALOG_GAME);
        ...
        public void ReleaseLoadedAssets()
        {
            ...
            _assetLoader.Unload(AssetsIDs.AUDIO_CATALOG_GAME);
        }
    }
}
